...
typedef enum {
    ...
    TOKEN_ERROR, // scanner will produce synthetic 'error' token (unterminated string, unrecognized chars) to pass to compiler - can hit error recovery before reoprting
    TOKEN_EOF
} TokenType;
